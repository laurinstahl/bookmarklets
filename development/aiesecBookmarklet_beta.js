javascript: (function () { 
	...
	scriptLocations.push({regEx:'https:\/\/experience\.aiesec\.org\/#\/people\\?my=true', scripts:[{url:'https://bookmarks.aiesec.de/bookmarklets/minified/v2_EXPA_preferred_locations.min.js',name:'show preferred locations'}]});
	...
	scriptLocations.push({regEx:'https:\/\/experience\.aiesec\.org\/#\/people\\?my=true', scripts:[{url:'https://bookmarks.aiesec.de/bookmarklets/minified/v2_EXPA_application_number.min.js',name:'show number of applications per EP'}]});		
	...
	scriptLocations.push({regEx:'https:\/\/experience\.aiesec\.org\/#\/analytics\/applications', scripts:[{url:'https://bookmarks.aiesec.de/bookmarklets/minified/v2_EXPA_analytics_signups.min',name:'show Sign-Ups'}]});
	...
	scriptLocations.push({regEx:'https:\/\/experience\.aiesec\.org\/#\/people\\?my=true', scripts:[{url:'https://bookmarks.aiesec.de/bookmarklets/minified/v2_EXPA_showProgram.min.js',name:'show Program'}]});
	...
	function addSitebarIntoPage(){
		addCSSIntoPage('https://drive.google.com/uc?export=download&id=0BxmSetMszPcscTlQcEg1MnkzY0E');
		addCSSIntoPage('https://drive.google.com/uc?export=download&id=0BxmSetMszPcsZ05hTGJSTm1zS0k');
